                ...
                Container(
                  ...
                  child: Center(
                    child: Text(
                        ...
                        style: TextStyle(fontSize: double.parse(context.watch<SettingProvider>().fontSize.toStringAsFixed(0)))
                    ),
                  ),
                ),
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        flex: 1,
                        child: Slider(
                          value: context.watch<SettingProvider>().fontSize,
                          min: 10,
                          max: 30,
                          onChanged: (double value) {
                            context.read<SettingProvider>().setFontSize(value);
                          },
                        ),
                      ),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        IconButton(
                            ...
                            icon: Icon(
                              context.watch<SettingProvider>().isNetwork
                                  ? Icons.toggle_on_outlined
                                  : Icons.toggle_off_outlined,
                              size: 50,
                            ),
                            onPressed: () {
                              context.read<SettingProvider>().setIsNetwork();
                            },
                        )
                      ],
                    ),
